...
public class MySquare2 : MyMesh
{
    ...
    {
        _triangles = [
            new MyTriangle(new Vector3(x,y,0), new Vector3(x+w,y,0), new Vector3(x+w,y+h,0)),
            new MyTriangle(new Vector3(x+w,y+h,0), new Vector3(x,y+h,0), new Vector3(x,y,0)),
        ];
        // _vertices = [
        //     x, y, 0,
        //     x+w, y, 0,
    ...
    public override void Draw(int colorSwitchLoc, int solidColorLoc, int transformLoc)
    {
        ...
        {
            t.Draw(colorSwitchLoc,solidColorLoc,transformLoc);
        }
    ...
    public override MyMesh Build()
    {
        ...
        //
        // float[] vertices = MyTriangle.TriangleToVertices(_triangles);
        //
    ...
    public override void SetSolidColor(Vector4 color)
    {
        foreach (var t in _triangles)
        {
